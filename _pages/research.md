...
(Numerical method, Finance) Approximates Markov processes by finite-state Markov chains using the maximum entropy method of Tanaka & Toda ([2013](http://doi.org/10.1016/j.econlet.2012.12.020), [2015](http://doi.org/10.1137/140971269)). Applications to solving asset pricing models.
...
(Power law, Empirical) Cross-sectional household consumption is well-approximated by double Pareto-lognormal distribution. Used to be a section of [Toda & Walsh (2015)](http://doi.org/10.1086/682729).
